...
from .views import CatsEveryWhereList, DeleteDataView, AddDataView, EditDataView, UpdateCatPositionView
...
urlpatterns = [
    ...
    path('reorder/', UpdateCatPositionView.as_view(), name = 'reorder-data'),
]